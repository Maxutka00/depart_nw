...
async def on_night_mode(chat_id: int, app: Client):
    try:
        ...
        message = await app.send_message(chat_id,
                                         f"""<b>Комендантська година починається за годину, але чат зачиняється, бо весь транспорт міста вже не працює,  
...
</b>З розкладами ознайомитись можно за посиланням - [<a href="https://t.me/DepTransDMR/109820">Натисніть, щоб перейти</a>]
