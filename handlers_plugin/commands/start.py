...
async def start(app, message: Message):
    ...
    mes_text = '''Щоб дізнатись расписание Автобусного/трамвайного/троллейбусного маршруту напишіть:
...
— Расписание междугородних поездов также международных прездов

Для того чтоб узнать все команды для администрации групп, напишите /help
